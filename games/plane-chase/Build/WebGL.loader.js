function createUnityInstance(t, r, d) {
    ...
    ;
    var l, u, h, f, p, g, m, b, y = "", v = "", w = (document.addEventListener("webkitfullscreenchange", function(e) {
        ...
        function o() {
            return void 0 === e ? a.arrayBuffer().then(function(e) {
                ...
                if (e.done) {
                    ...
                    if (h < l)
                        return u.slice(0, h);
                    for (var t = new Uint8Array(h), r = (t.set(u, 0),
                    f), n = 0; n < c.length; ++n)
                        t.set(c[n], r),
                        r += c[n].length;
                    return t
                }
                return h + e.value.length <= u.length ? (u.set(e.value, h),
