...
!(function () {
  ...
  var m,
    ...
    g = new (function () {
      ...
      function p(e) {
        ...
        for (t = 0; t <= 3; t++)
          a +=
            n.charAt((e >> (8 * t + 4)) & 15) + n.charAt((e >> (8 * t)) & 15);
        return a;
      }
      function c(e, t, a, n, r, d) {
          ...
          for (
            var t = (function (e) {
                var t,
                  a = 1 + ((e.length + 8) >> 6),
                  n = new Array(16 * a);
                for (t = 0; t < 16 * a; t++) n[t] = 0;
                for (t = 0; t < e.length; t++)
                  n[t >> 2] |=
                    e.charCodeAt(t) << (((8 * e.length + t) % 4) * 8);
              ...
              (n = v(
                (n = v(
                      ...
                      (n = h(
                        (n = h(
                          ...
                          (r = h(
                            ...
                            (d = h(
                              d,
                              (a = h(a, n, r, d, t[i + 1], 4, -1530992060)),
                              n,
                              r,
                              t[i + 4],
                              11,
                        ...
                        (r = h(
                          ...
                          (d = h(
                            d,
                            (a = h(a, n, r, d, t[i + 13], 4, 681279174)),
                            n,
                            r,
                            t[i + 0],
                            11,
                  ...
                  (r = v(
                    ...
                    (d = v(
                      d,
                      (a = v(a, n, r, d, t[i + 12], 6, 1700485571)),
                      n,
                      r,
                      t[i + 3],
                      10,
                ...
                (r = v(
                  ...
                  (d = v(
                    d,
                    (a = v(a, n, r, d, t[i + 8], 6, 1873313359)),
                    n,
                    r,
                    t[i + 15],
                    10,
  ...
  if (isDevMode) {
    ...
    CSSlink.href = "../style/devmode.css";
    CSSlink.rel = "stylesheet";
    CSSlink.media = "screen";
    document.getElementsByTagName("head")[0].appendChild(CSSlink);
  } else {
    var CSSlink = document.createElement("link");
    CSSlink.href = "../style/base.css";
    CSSlink.rel = "stylesheet";
    CSSlink.media = "screen";
    document.getElementsByTagName("head")[0].appendChild(CSSlink);
  }
  ...
  pookiAPI.init = function (developer_id, dev_adsense_id, usePreloader) {
    ...
    if (isOnApprovedWebsite) {
      ...
      try {
        ...
        element.setAttribute("data-ad-host", "");
          ...
          if (isOnpooki) {
            if (window.parent.customHostChannel) {
              element.setAttribute(
                ...
                window.parent.customHostChannel
              );
            }
    ...
    try {
      if (isOnpooki) {
        if (
          ...
          window.parent.aValueRules.length > 0
        ) {
          aFoundValue = true;
    ...
    save: function (e, t) {
      ...
      0 < b.length
        ? ((r = b.length),
          (d = t),
          setTimeout(function () {
            if (b.length > r) d({ success: !0 });
            else {
              var e = { action: "save" };
              (e.publickey = m), (e.awards = b), (b = []);
  ...
  pookiAPI.Scores = {
    save: function (e, t) {
      ...
      var a = { action: "save" };
      (a.publickey = m), (a.board = e.board), (a.score = e.score);
      ...
      if (isDevMode) {
        ...
        sampleAdPopup.innerHTML =
          "<p>Score: " + e.score + "<br>Board ID: " + e.board + "</p>";
        document.body.appendChild(sampleAdPopup);
  ...
  var E,
    f = function (e, t) {
      var a = { success: !0 };
      e && !0 === e.success
        ? !0 === e.data.show && N(e.data.achdata, e.user)
        : (alert("Error: Achievement did not save!"),
          console.log(e),
          (a.success = !1),
  ...
  pookiAPI.GEvents = {
    start: function (adResponse) {
      ...
      adBreak({
        ...
        afterAd: () => {
          enableButtons();
          if (parent_campaign_id < 1 && !isDevMode) {
            adTimer = -15;
          } else {
            adTimer = 0;
          }
    ...
    reward: function (canShowButton, callback) {
      ...
      if (canGiveReward) {
        if (isDevMode) {
          console.log(
            "Do not check reward ad again until previous reward ad is viewed"
          );
        }
  ...
  function devModeRewardCallback() {
    ...
    //dev to do, pop up
    console.log(
      "DEV MODE: Showing example reward ad, ad will close in 3 seconds."
    );
    ...
    show: function (response) {
      ...
      if (isDevMode) {
        ...
        if (!initCheck && !isTestingMode) {
          alert(
            "INIT function not called, or calling Ad too soon. TIP: Call INIT function after load, call Ad on play button click."
          );
          return;
        }
        ...
        try {
          ...
          if (messageType === "parentCustomChannel") {
            ...
            if (document.getElementById("gamesourcegoogle")) {
              document
                .getElementById("gamesourcegoogle")
                .setAttribute("data-ad-host-channel", parentChanneltoUse);
              console.log("channel to use: ", parentChanneltoUse);
            }
          }
        } catch (e) {
