function createUnityInstance(e, t, r) {
  ...
  function s(e, t) {
    if ("symbolsUrl" != e) {
      ...
      n || (n = f.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }), "object" != typeof t || ("progress" != t.type && "load" != t.type) || (n.started || ((n.started = !0), (n.lengthComputable = t.lengthComputable), (n.total = t.total)), (n.loaded = t.loaded), "load" == t.type && (n.finished = !0));
      var o = 0,
        a = 0,
        i = 0,
        s = 0,
  ...
  function l(e, t, r) {
    for (var n in g)
      if (g[n].hasUnityMarker(e)) {
        ...
        return (o.worker.callbacks[i] = r), void o.worker.postMessage({ id: i, compressed: e }, [e.buffer]);
      }
    r(e);
  }
  function d(e) {
    return new Promise(function (t, r) {
      s(e);
      var o = f.companyName && f.productName ? new f.XMLHttpRequest({ companyName: f.companyName, productName: f.productName, cacheControl: f.cacheControl(f[e]) }) : new XMLHttpRequest();
      o.open("GET", f[e]),
  ...
  function u() {
    return d("frameworkUrl").then(function (e) {
      ...
      return new Promise(function (e, r) {
        ...
        (o.src = t),
          (o.onload = function () {
            var d = mygameunityFramework;
            (mygameunityFramework = null), (o.onload = null), URL.revokeObjectURL(t), e(d);
          }),
  ...
  document.addEventListener("webkitfullscreenchange", function (t) {
    ...
    r === e ? e.style.width && ((b = e.style.width), (m = e.style.height), (e.style.width = "100%"), (e.style.height = "100%")) : b && ((e.style.width = b), (e.style.height = m), (b = ""), (m = ""));
  });
  var w = {
    Module: f,
  ...
  (f.SystemInfo = (function () {
    ...
    (f.XMLHttpRequest = (function () {
          ...
          this.xhr.addEventListener(
            ...
            function () {
              ...
              r.enabled &&
                !r.revalidated &&
                (304 == t.status
                  ? ((r.result.revalidated = r.result.accessed), (r.revalidated = !0), d.execute(s.name, "put", [r.result]), e("'" + r.result.url + "' successfully revalidated and served from the indexedDB cache"))
                  : 200 == t.status
      ...
      n.prototype.execute = function (e, t, r, n, o) {
        ...
        else "undefined" == typeof this.database ? this.queue.push({ arguments: arguments, onerror: o }) : "function" == typeof o && o(new Error("indexedDB access denied"));
      };
      var d = new n();
        ...
        var t = {
          "inflate.js": function (e, t, r) {
            ...
            (n.prototype.push = function (e, t) {
              ...
              do {
                if ((0 === f.avail_out && ((f.output = new s.Buf8(p)), (f.next_out = 0), (f.avail_out = p)), (r = i.inflate(f, d.Z_NO_FLUSH)), r === d.Z_NEED_DICT && b && ((c = "string" == typeof b ? l.string2buf(b) : "[object ArrayBuffer]" === h.call(b) ? new Uint8Array(b) : b), (r = i.inflateSetDictionary(this.strm, c))), r === d.Z_BUF_ERROR && m === !0 && ((r = d.Z_OK), (m = !1)), r !== d.Z_STREAM_END && r !== d.Z_OK)) return this.onEnd(r), (this.ended = !0), !1;
                f.next_out && ((0 !== f.avail_out && r !== d.Z_STREAM_END && (0 !== f.avail_in || (n !== d.Z_FINISH && n !== d.Z_SYNC_FLUSH))) || ("string" === this.options.to ? ((o = l.utf8border(f.output, f.next_out)), (a = f.next_out - o), (u = l.buf2string(f.output, o)), (f.next_out = a), (f.avail_out = p - a), a && s.arraySet(f.output, f.output, o, a, 0), this.onData(u)) : this.onData(s.shrinkBuf(f.output, f.next_out)))), 0 === f.avail_in && 0 === f.avail_out && (m = !0);
          ...
          "zlib/inflate.js": function (e, t, r) {
            ...
            function a(e) {
              var t;
              return e && e.state ? ((t = e.state), (e.total_in = e.total_out = t.total = 0), (e.msg = ""), t.wrap && (e.adler = 1 & t.wrap), (t.mode = D), (t.last = 0), (t.havedict = 0), (t.dmax = 32768), (t.head = null), (t.hold = 0), (t.bits = 0), (t.lencode = t.lendyn = new g.Buf32(be)), (t.distcode = t.distdyn = new g.Buf32(me)), (t.sane = 1), (t.back = -1), L) : O;
            }
            function i(e) {
              var t;
            ...
            function l(e, t) {
              var r, n;
              return e ? ((n = new o()), (e.state = n), (n.window = null), (r = s(e, t)), r !== L && (e.state = null), r) : O;
            }
            function d(e) {
              return l(e, ge);
            }
            ...
            function f(e, t) {
              ...
              (r = e.state), r.mode === K && (r.mode = V), (s = e.next_out), (a = e.output), (d = e.avail_out), (i = e.next_in), (o = e.input), (l = e.avail_in), (f = r.hold), (h = r.bits), (p = l), (b = d), (_e = L);
              e: for (;;)
                switch (r.mode) {
                  case D:
                    if (0 === r.wrap) {
                    ...
                    if (2 & r.wrap && 35615 === f) {
                      (r.check = 0), (Ue[0] = 255 & f), (Ue[1] = (f >>> 8) & 255), (r.check = y(r.check, Ue, 2, 0)), (f = 0), (h = 0), (r.mode = z);
                      break;
                    }
                  ...
                  case z:
                    ...
                    r.head && (r.head.text = (f >> 8) & 1), 512 & r.flags && ((Ue[0] = 255 & f), (Ue[1] = (f >>> 8) & 255), (r.check = y(r.check, Ue, 2, 0))), (f = 0), (h = 0), (r.mode = F);
                  case F:
                    for (; h < 32; ) {
                      if (0 === l) break e;
                      l--, (f += o[i++] << h), (h += 8);
                  ...
                  case Z:
                    ...
                    r.mode = M;
                  case M:
                    if (1024 & r.flags && ((m = r.length), m > l && (m = l), m && (r.head && ((xe = r.head.extra_len - r.length), r.head.extra || (r.head.extra = new Array(r.head.extra_len)), g.arraySet(r.head.extra, o, i, m, xe)), 512 & r.flags && (r.check = y(r.check, o, m, i)), (l -= m), (i += m), (r.length -= m)), r.length)) break e;
                    (r.length = 0), (r.mode = j);
                  case j:
                    if (2048 & r.flags) {
                      if (0 === l) break e;
                      m = 0;
                      do (xe = o[i + m++]), r.head && xe && r.length < 65536 && (r.head.name += String.fromCharCode(xe));
                      while (xe && m < l);
                      if ((512 & r.flags && (r.check = y(r.check, o, m, i)), (l -= m), (i += m), xe)) break e;
                  ...
                  case W:
                    if (4096 & r.flags) {
                      if (0 === l) break e;
                      m = 0;
                      do (xe = o[i + m++]), r.head && xe && r.length < 65536 && (r.head.comment += String.fromCharCode(xe));
                      while (xe && m < l);
                      if ((512 & r.flags && (r.check = y(r.check, o, m, i)), (l -= m), (i += m), xe)) break e;
                  ...
                  case Y:
                    ...
                    if (((r.length = 65535 & f), (f = 0), (h = 0), (r.mode = Q), t === T)) break e;
                  case Q:
                    r.mode = J;
                  case J:
                    if ((m = r.length)) {
                      if ((m > l && (m = l), m > d && (m = d), 0 === m)) break e;
                      g.arraySet(a, o, i, m, s), (l -= m), (i += m), (d -= m), (s += m), (r.length -= m);
                      break;
                    }
                    r.mode = K;
                    break;
                  ...
                  case ee:
                    for (; r.have < r.ncode; ) {
                      ...
                      (r.lens[Te[r.have++]] = 7 & f), (f >>>= 3), (h -= 3);
                    }
                    for (; r.have < 19; ) r.lens[Te[r.have++]] = 0;
                    if (((r.lencode = r.lendyn), (r.lenbits = 7), (Se = { bits: r.lenbits }), (_e = x(_, r.lens, 0, 19, r.lencode, 0, r.work, Se)), (r.lenbits = Se.bits), _e)) {
                  ...
                  case te:
                    for (; r.have < r.nlen + r.ndist; ) {
                      for (; (Ce = r.lencode[f & ((1 << r.lenbits) - 1)]), (me = Ce >>> 24), (we = (Ce >>> 16) & 255), (ge = 65535 & Ce), !(me <= h); ) {
                        if (0 === l) break e;
                        l--, (f += o[i++] << h), (h += 8);
                      }
                      if (ge < 16) (f >>>= me), (h -= me), (r.lens[r.have++] = ge);
                      else {
                        if (16 === ge) {
                          for (Ee = me + 2; h < Ee; ) {
                            if (0 === l) break e;
                          ...
                          (xe = r.lens[r.have - 1]), (m = 3 + (3 & f)), (f >>>= 2), (h -= 2);
                        } else if (17 === ge) {
                          for (Ee = me + 3; h < Ee; ) {
                            if (0 === l) break e;
                            l--, (f += o[i++] << h), (h += 8);
                    ...
                    if (((r.lenbits = 9), (Se = { bits: r.lenbits }), (_e = x(S, r.lens, 0, r.nlen, r.lencode, 0, r.work, Se)), (r.lenbits = Se.bits), _e)) {
                      (e.msg = "invalid literal/lengths set"), (r.mode = fe);
                      break;
                    }
                    if (((r.distbits = 6), (r.distcode = r.distdyn), (Se = { bits: r.distbits }), (_e = x(E, r.lens, r.nlen, r.ndist, r.distcode, 0, r.work, Se)), (r.distbits = Se.bits), _e)) {
                  ...
                  case ne:
                    if (l >= 6 && d >= 258) {
                      (e.next_out = s), (e.avail_out = d), (e.next_in = i), (e.avail_in = l), (r.hold = f), (r.bits = h), k(e, b), (s = e.next_out), (a = e.output), (d = e.avail_out), (i = e.next_in), (o = e.input), (l = e.avail_in), (f = r.hold), (h = r.bits), r.mode === K && (r.back = -1);
                      break;
                    }
                    for (r.back = 0; (Ce = r.lencode[f & ((1 << r.lenbits) - 1)]), (me = Ce >>> 24), (we = (Ce >>> 16) & 255), (ge = 65535 & Ce), !(me <= h); ) {
                      if (0 === l) break e;
                      l--, (f += o[i++] << h), (h += 8);
                    }
                    if (we && 0 === (240 & we)) {
                      for (ve = me, ye = we, ke = ge; (Ce = r.lencode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]), (me = Ce >>> 24), (we = (Ce >>> 16) & 255), (ge = 65535 & Ce), !(ve + me <= h); ) {
                        if (0 === l) break e;
                        l--, (f += o[i++] << h), (h += 8);
                      }
                      (f >>>= ve), (h -= ve), (r.back += ve);
                    }
                    if (((f >>>= me), (h -= me), (r.back += me), (r.length = ge), 0 === we)) {
                      r.mode = le;
                      break;
                    }
                    if (32 & we) {
                  ...
                  case ae:
                    for (; (Ce = r.distcode[f & ((1 << r.distbits) - 1)]), (me = Ce >>> 24), (we = (Ce >>> 16) & 255), (ge = 65535 & Ce), !(me <= h); ) {
                      if (0 === l) break e;
                      l--, (f += o[i++] << h), (h += 8);
                    }
                    if (0 === (240 & we)) {
                      for (ve = me, ye = we, ke = ge; (Ce = r.distcode[ke + ((f & ((1 << (ve + ye)) - 1)) >> ve)]), (me = Ce >>> 24), (we = (Ce >>> 16) & 255), (ge = 65535 & Ce), !(ve + me <= h); ) {
                        if (0 === l) break e;
                        l--, (f += o[i++] << h), (h += 8);
                      }
                      (f >>>= ve), (h -= ve), (r.back += ve);
                  ...
                  case se:
                    ...
                    if (((m = b - d), r.offset > m)) {
                      ...
                      m > r.wnext ? ((m -= r.wnext), (w = r.wsize - m)) : (w = r.wnext - m), m > r.length && (m = r.length), (be = r.window);
                  ...
                  case de:
                    if (r.wrap) {
                      ...
                      if (((b -= d), (e.total_out += b), (r.total += b), b && (e.adler = r.check = r.flags ? y(r.check, a, b, s - b) : v(r.check, a, b, s - b)), (b = d), (r.flags ? f : n(f)) !== r.check)) {
            ...
            function p(e, t) {
              var r;
              return e && e.state ? ((r = e.state), 0 === (2 & r.wrap) ? O : ((r.head = t), (t.done = !1), L)) : O;
            }
            function b(e, t) {
              var r,
                n,
                o,
                a = t.length;
              return e && e.state ? ((r = e.state), 0 !== r.wrap && r.mode !== X ? O : r.mode === X && ((n = 1), (n = v(n, t, a, 0)), n !== r.check) ? H : (o = c(e, t, a, a)) ? ((r.mode = he), A) : ((r.havedict = 1), L)) : O;
            }
            var m,
              w,
              g = e("../utils/common"),
              ...
              ge = we,
              ve = !0;
            (r.inflateReset = i), (r.inflateReset2 = s), (r.inflateResetKeep = a), (r.inflateInit = d), (r.inflateInit2 = l), (r.inflate = f), (r.inflateEnd = h), (r.inflateGetHeader = p), (r.inflateSetDictionary = b), (r.inflateInfo = "pako inflate (from Nodeca project)");
          },
          ...
          "zlib/inffast.js": function (e, t, r) {
            ...
            t.exports = function (e, t) {
              var r, a, i, s, l, d, u, c, f, h, p, b, m, w, g, v, y, k, x, _, S, E, C, U, T;
              (r = e.state), (a = e.next_in), (U = e.input), (i = a + (e.avail_in - 5)), (s = e.next_out), (T = e.output), (l = s - (t - e.avail_out)), (d = s + (e.avail_out - 257)), (u = r.dmax), (c = r.wsize), (f = r.whave), (h = r.wnext), (p = r.window), (b = r.hold), (m = r.bits), (w = r.lencode), (g = r.distcode), (v = (1 << r.lenbits) - 1), (y = (1 << r.distbits) - 1);
              e: do {
                m < 15 && ((b += U[a++] << m), (m += 8), (b += U[a++] << m), (m += 8)), (k = w[b & v]);
                t: for (;;) {
                  if (((x = k >>> 24), (b >>>= x), (m -= x), (x = (k >>> 16) & 255), 0 === x)) T[s++] = 65535 & k;
                  else {
                    if (!(16 & x)) {
                      if (0 === (64 & x)) {
                        k = w[(65535 & k) + (b & ((1 << x) - 1))];
                    ...
                    (_ = 65535 & k), (x &= 15), x && (m < x && ((b += U[a++] << m), (m += 8)), (_ += b & ((1 << x) - 1)), (b >>>= x), (m -= x)), m < 15 && ((b += U[a++] << m), (m += 8), (b += U[a++] << m), (m += 8)), (k = g[b & y]);
                    r: for (;;) {
                      ...
                      if (((S = 65535 & k), (x &= 15), m < x && ((b += U[a++] << m), (m += 8), m < x && ((b += U[a++] << m), (m += 8))), (S += b & ((1 << x) - 1)), S > u)) {
                      ...
                      if (((b >>>= x), (m -= x), (x = s - l), S > x)) {
                        ...
                        for (; _ > 2; ) (T[s++] = C[E++]), (T[s++] = C[E++]), (T[s++] = C[E++]), (_ -= 3);
                        _ && ((T[s++] = C[E++]), _ > 1 && (T[s++] = C[E++]));
                      } else {
                        E = s - S;
                        do (T[s++] = T[E++]), (T[s++] = T[E++]), (T[s++] = T[E++]), (_ -= 3);
                        while (_ > 2);
                        _ && ((T[s++] = T[E++]), _ > 1 && (T[s++] = T[E++]));
                      }
                      break;
                    }
                  }
              ...
              (_ = m >> 3), (a -= _), (m -= _ << 3), (b &= (1 << m) - 1), (e.next_in = a), (e.next_out = s), (e.avail_in = a < i ? 5 + (i - a) : 5 - (a - i)), (e.avail_out = s < d ? 257 + (d - s) : 257 - (s - d)), (r.hold = b), (r.bits = m);
            };
          },
          "zlib/inftrees.js": function (e, t, r) {
            ...
            t.exports = function (e, t, r, p, b, m, w, g) {
              ...
              for (H = T, O = o; O >= 1 && 0 === Z[O]; O--);
              if ((H > O && (H = O), 0 === O)) return (b[m++] = 20971520), (b[m++] = 20971520), (g.bits = 1), 0;
              for (B = 1; B < O && 0 === Z[B]; B++);
              for (H < B && (H = B), N = 1, L = 1; L <= o; L++) if (((N <<= 1), (N -= Z[L]), N < 0)) return -1;
              if (N > 0 && (e === s || 1 !== O)) return -1;
              for (M[1] = 0, L = 1; L < o; L++) M[L + 1] = M[L] + Z[L];
              for (R = 0; R < p; R++) 0 !== t[r + R] && (w[M[t[r + R]]++] = R);
              if ((e === s ? ((F = j = w), (S = 19)) : e === l ? ((F = u), (P -= 257), (j = c), (W -= 257), (S = 256)) : ((F = f), (j = h), (S = -1)), (z = 0), (R = 0), (L = B), (_ = m), (A = H), (I = 0), (k = -1), (D = 1 << H), (x = D - 1), (e === l && D > a) || (e === d && D > i))) return 1;
              for (;;) {
                (E = L - I), w[R] < S ? ((C = 0), (U = w[R])) : w[R] > S ? ((C = j[W + w[R]]), (U = F[P + w[R]])) : ((C = 96), (U = 0)), (v = 1 << (L - I)), (y = 1 << A), (B = y);
                do (y -= v), (b[_ + (z >> I) + y] = (E << 24) | (C << 16) | U | 0);
                while (0 !== y);
                for (v = 1 << (L - 1); z & v; ) v >>= 1;
                if ((0 !== v ? ((z &= v - 1), (z += v)) : (z = 0), R++, 0 === --Z[L])) {
                  if (L === O) break;
                  L = t[r + w[R]];
                }
                if (L > H && (z & x) !== k) {
                  for (0 === I && (I = H), _ += B, A = L - I, N = 1 << A; A + I < O && ((N -= Z[A + I]), !(N <= 0)); ) A++, (N <<= 1);
                  if (((D += 1 << A), (e === l && D > a) || (e === d && D > i))) return 1;
                  (k = z & x), (b[k] = (H << 24) | (A << 16) | (_ - m) | 0);
                }
              }
              return 0 !== z && (b[_ + z] = ((L - I) << 24) | (64 << 16) | 0), (g.bits = H), 0;
            };
          },
        };
  ...
  return new Promise(function (e, t) {
    f.SystemInfo.hasWebGL
      ? f.SystemInfo.hasWasm
        ? (1 == f.SystemInfo.hasWebGL && f.print('Warning: Your browser does not support "WebGL 2.0" Graphics API, switching to "WebGL 1.0"'),
