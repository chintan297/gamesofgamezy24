function CScoreBoard(iLevel,pContainerPos,oParentContainer) {
    ...
    this._init = function (iLevel,pContainerPos) {
        ...
        var oNicknameText = new createjs.Text(/*TEXT_TEAM[s_iTeamSelected]*/TEXT_PLAYER_1, "32px " + PRIMARY_FONT, TEXT_COLOR);
        ...
        var szName = "";
        if(s_bMultiplayer){
            szName = TEXT_PLAYER_2;
        }else {
            szName = TEXT_CPU;
        }

        _oCpuText = new createjs.Text(/*TEXT_TEAM[s_aMatches[iLevel-1]]*/szName, "32px " + PRIMARY_FONT, TEXT_COLOR);
    ...
    this.setPlayersName = function(szPlayer, szOpponent){
        ...
        _oPlayerName = new createjs.Text("("+szPlayer+")", "16px " + PRIMARY_FONT, TEXT_COLOR);
        _oPlayerName.x = _oScoreText.x - _oScoreText.getBounds().width - 65;
        _oPlayerName.y = 54;
        _oPlayerName.textAlign = "right";
        _oPlayerName.textBaseline = "alphabetic";
        _oContainerText.addChild(_oPlayerName);
        
        _oOpponentName = new createjs.Text("("+szOpponent+")", "16px " + PRIMARY_FONT, TEXT_COLOR);
        _oOpponentName.x = _oScoreText.x - _oScoreText.getBounds().width - 65;
        _oOpponentName.y = _oPlayerName.y + 42;
        _oOpponentName.textAlign = "right";
        _oOpponentName.textBaseline = "alphabetic";
        _oContainerText.addChild(_oOpponentName);
    }
