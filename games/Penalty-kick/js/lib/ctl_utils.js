...
function createOrthoGraphicCamera() {
	var oCamera = new THREE.PerspectiveCamera(
		FOV,
...
function clearAllItem() {
	...
	for (var i = 1; i < NUM_MATCHES + 1; i++) {
		localStorage.removeItem(LOCALSTORAGE_STRING + "match_" + i)
	}
	localStorage.removeItem(LOCALSTORAGE_STRING + "team")
	localStorage.removeItem(LOCALSTORAGE_STRING + "level")
	localStorage.removeItem(LOCALSTORAGE_STRING + "team")
}
