(() =>
{
                                ...
                                if ((t = window.PokiSDK)[a].apply(t, u).catch((function()
                                    {
                                        ...
                                        "function" == typeof i.rejectFn && i.rejectFn.apply(i, t), c && setTimeout((function()
                                        {
                                            e.dequeue()
                                        }), 0)
                                    })).then((function()
                                    {
                                        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                                        "function" == typeof i.resolveFn && i.resolveFn.apply(i, t), c && setTimeout((function()
                                        {
                                            e.dequeue()
                                        }), 0)
                                    })), c) return "break"
    ...
    //             r = "poki-sdk-core.js";
    //         t && (r = "poki-sdk-kids-".concat(i, ".js")), n && (r = "poki-sdk-playground.js"), o && (r = "poki-sdk-hoist.js");
    //         new URL(document.currentScript.src);
    //         return "./".concat(i, "/").concat(r)
    //     }(),
    var r = "./poki-sdk-core.js",
        a = document.createElement("script");
    a.setAttribute("src", r), a.setAttribute("type", "text/javascript"), a.setAttribute("crossOrigin", "anonymous"), a.onload = function()
    {
        return i.dequeue()
