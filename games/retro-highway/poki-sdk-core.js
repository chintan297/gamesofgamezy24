    ...
    var G = function() {
        ...
        Q = function() {
            ...
            return t.prototype.setupEvents = function(t) {
                ...
                this.hideElement(this.containerDiv), this.hideElement(this.progressContainer), this.hidePauseButton(), this.hideElement(this.startAdButton)//, 
    ...
    var $ = function(t, n, e, i) {
        ...
        nt = function() {
            ...
            return t.prototype.initAdDisplayContainer = function() {
                ...
                // || (this.adDisplayContainer = new google.ima.AdDisplayContainer(document.getElementById("pokiSDKAdContainer"), this.videoElement))
