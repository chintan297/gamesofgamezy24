	...
	function () {
		...
		function loadData() {
			return new Promise(resolve => {
				...
				// -------------- CUSTOM STORAGE (LOADING) --------------
				let value = window.famobi.localStorage.getItem(storageKey);
				// ------------------------------------------------------
		...
		function saveData() {
			return new Promise(resolve => {
				...
				// ---------------- CUSTOM STORAGE (SAVE) ----------------
				if(value) {
					window.famobi.localStorage.setItem(storageKey, value);
				} else {
					window.famobi.localStorage.removeItem(storageKey);
				}
				// -------------------------------------------------------
