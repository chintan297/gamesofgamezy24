        ...
        return (
          ...
          (t.prototype.createElements = function () {
            if (
              ...
              (this.containerDiv.className = "pookiSdkContainer"),
              (this.insideContainer.className = "pookiSdkInsideContainer"),
              (this.pauseButton.className = N),
              (this.pauseButton.innerHTML = "Tap anywhere to ▶️"),
              (this.startAdButton.className = "pookiSdkStartAdButton"),
              (this.startAdButton.innerHTML = "Tap anywhere to play ad"),
              (this.progressBar.className = F),
              (this.progressContainer.className = "pookiSdkProgressContainer"),
              (this.spinnerContainer.className = X),
              (this.adContainer.className = "pookiSDKAdContainer"),
              (this.videoContainer.className = "pookiSdkVideoContainer"),
              (this.spinnerContainer.innerHTML =
                '\n\t\t\t<div id="new-progress-spinner" style="z-index:10;position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%) scale3d(0.5, 0.5, 0.5);">\n\t\t\t\t<div class="gwd-div-1v1s" data-gwd-group="SpinnerGroup">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_1.svg" class="gwd-img-1653 gwd-gen-no02gwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_1">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_2.svg" class="gwd-img-alsm gwd-gen-4pvrgwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_2">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_3.svg" class="gwd-img-f0mu gwd-gen-kw40gwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_3">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_4.svg" class="gwd-img-1sr3 gwd-gen-2uv8gwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_4">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_5.svg" class="gwd-img-1ffn gwd-gen-1x97gwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_5">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_6.svg" class="gwd-img-16f3 gwd-gen-1i1egwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_6">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/Sparkle_7.svg" class="gwd-img-1rrs gwd-gen-1sapgwdanimation gwd-grp-13td" data-gwd-grp-id="Sparkle_7">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2.0/static/hand_fingers_isolated.svg" class="gwd-img-1dhi gwd-gen-5qotgwdanimation gwd-grp-13td" data-gwd-grp-id="heart">\n\t\t\t\t\t<img src="https://game-cdn.pookigame.com/loaders/v2/static/spinner/shadow_new_3.svg" class="gwd-img-1izg gwd-gen-faadgwdanimation gwd-grp-13td" data-gwd-grp-id="shadow_new_3">\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t'),
              this.hide(),
              ...
              this.containerDiv.classList.add("pookiSdkFixed");
            else {
                ...
                return (
                  (t = i.sent()) &&
                    (((n = document.createElement("script")).src =
                      "//game-cdn.pookigame.com/scripts/touchOverlayController.js"),
                    (n.onload = function () {
