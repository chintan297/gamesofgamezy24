...
loadState.prototype = {
  preload: function () {
    ...
    this.loadText = this.add.text(
      ...
      this.world.centerY,
      "loading ",
      { font: Font, fill: "#99CC0E", stroke: "#55B50D", strokeThickness: 3 }
    );
    ...
    this.load.audio(
      "fruitGulp",
      [
        "sounds/fruitGulp.wav",
        "sounds/fruitGulp.ogg",
        "sounds/fruitGulp.mp3",
        "sounds/fruitGulp.m4a",
      ],
      true
    );
    this.load.audio(
    ...
    this.load.audio(
      "cocoSound",
      ["sounds/dap.mp3", "sounds/dap.wav", "sounds/dap.ogg", "sounds/dap.m4a"],
      true
    );
  },
  ...
  create: function () {
    this.sound.setDecodedCallback(
      ["gemSound", "menuBg", "jumpSound", "deadSound"],
      function () {
