function createUnityInstance(r, n, l) {
  ...
  var h = {
    ...
    GetMemoryInfo: function () {
      var e = c._getMemInfo();
      return { totalWASMHeapSize: c.HEAPU32[e >> 2], usedWASMHeapSize: c.HEAPU32[1 + (e >> 2)], totalJSHeapSize: c.HEAPF64[1 + (e >> 3)], usedJSHeapSize: c.HEAPF64[2 + (e >> 3)] };
    },
  };
  function g(e, r, n) {
  ...
  function p(e, r) {
    if ("symbolsUrl" != e) {
      var n = c.downloadProgress[e],
        t = ((n = n || (c.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })), "object" != typeof r || ("progress" != r.type && "load" != r.type) || (n.started || ((n.started = !0), (n.lengthComputable = r.lengthComputable)), (n.total = r.total), (n.loaded = r.loaded), "load" == r.type && (n.finished = !0)), 0),
        o = 0,
        a = 0,
        i = 0,
        s = 0;
  ...
  function m() {
    new Promise(function (a, e) {
      ...
      (i.src = c.frameworkUrl),
        (i.onload = function () {
          var o = my4399unityFramework;
          (my4399unityFramework = null), (i.onload = null), a(o);
        }),
  ...
  return (
    (c.SystemInfo = (function () {
      ...
      var u,
        c = { "NT 5.0": "2000", "NT 5.1": "XP", "NT 5.2": "Server 2003", "NT 6.0": "Vista", "NT 6.1": "7", "NT 6.2": "8", "NT 6.3": "8.1", "NT 10.0": "10" }[c] || c,
    ...
    (c.readBodyWithProgress = function (a, i, s) {
      var e = a.body ? a.body.getReader() : void 0,
        ...
        h = 0;
      return (
        l || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."),
        (function o() {
          return void 0 === e
            ? a.arrayBuffer().then(function (e) {
                var r = new Uint8Array(e);
                return i({ type: "progress", response: a, total: e.length, loaded: 0, lengthComputable: l, chunk: s ? r : null }), r;
              })
            : e.read().then(function (e) {
                ...
                return f + e.value.length <= u.length ? (u.set(e.value, f), (h = f + e.value.length)) : c.push(e.value), (f += e.value.length), i({ type: "progress", response: a, total: Math.max(d, f), loaded: f, lengthComputable: l, chunk: s ? e.value : null }), o();
              });
        })().then(function (e) {
    ...
    new Promise(function (e, r) {
      ...
      c.SystemInfo.hasWebGL
        ? 1 == c.SystemInfo.hasWebGL
          ? ((n = 'Your browser does not support graphics API "WebGL 2" which is required for this content.'), "Safari" == c.SystemInfo.browser && parseInt(c.SystemInfo.browserVersion) < 15 && (c.SystemInfo.mobile || 1 < navigator.maxTouchPoints ? (n += "\nUpgrade to iOS 15 or later.") : (n += "\nUpgrade to Safari 15 or later.")), r(n))
