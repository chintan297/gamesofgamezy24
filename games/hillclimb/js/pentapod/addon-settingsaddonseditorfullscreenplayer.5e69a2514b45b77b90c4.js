(window.webpackJsonpGUI = window.webpackJsonpGUI || []).push([
  [1],
  {
    147: function (e, t, s) {
      ...
      class c extends n.a {
        constructor() {
          super(), (this.store = this.createEmptyStore()), (this.remote = !1);
        }
        createEmptyStore() {
          const e = {};
          for (const t of Object.keys(a.a)) e[t] = {};
          return e;
        }
        readLocalStorage() {
          const e = this.store;
              ...
              if (s && "object" == typeof s) {
                s = ((e) => {
                  ...
                  if (t < 2) {
                    ...
                    t && t.enabled && (e["block-count"] = { enabled: !0 });
                    const s = e["tw-interface-customization"];
                    s &&
                      s.enabled &&
                      (s.removeBackpack &&
                        (e["tw-remove-backpack"] = { enabled: !0 }),
                      s.removeFeedback &&
                        (e["tw-remove-feedback"] = { enabled: !0 }));
                  }
                  if (t < 3) {
                  ...
                  if (t < 4) {
                    ...
                    t &&
                      !1 === t.enabled &&
                      ((e["find-bar"] = { enabled: !1 }),
                      (e["middle-click-popup"] = { enabled: !1 }));
                  }
                  if (t < 5) {
        ...
        getAddonSetting(e, t) {
          ...
          if (!o) throw new Error("Unknown setting: ".concat(t));
          return Object.prototype.hasOwnProperty.call(s, t) ? s[t] : o.default;
        }
        getDefaultSettings(e) {
          const t = this.getAddonManifest(e),
            s = {};
          for (const { id: e, default: a } of t.settings) s[e] = a;
          return s;
        }
        setAddonEnabled(e, t) {
          const s = this.getAddonStorage(e),
          ...
          if (null === t) (t = !!a.enabledByDefault), delete s.enabled;
          else {
            if ("boolean" != typeof t)
        ...
        setAddonSetting(e, t, s) {
          ...
          if (null === s) (s = n.default), delete a[t];
          else {
            if ("boolean" === n.type) {
              if ("boolean" != typeof s)
                throw new Error("Setting value is invalid.");
            } else if ("integer" === n.type || "positive_integer" === n.type) {
              if ("number" != typeof s)
                throw new Error("Setting value is invalid.");
            } else if ("string" === n.type || "untranslated" === n.type);
        ...
        applyAddonPreset(e, t) {
          ...
          for (const { id: a, values: o } of s.presets) {
            ...
            for (const t of Object.keys(s)) this.setAddonSetting(e, t, s[t]);
            return;
          }
          throw new Error("Unknown preset: ".concat(t));
        }
        resetAllAddons() {
          for (const e of Object.keys(a.a)) this.resetAddon(e, !0);
          (this.store = this.createEmptyStore()), this.saveToLocalStorage();
        }
        resetAddon(e, t) {
          const s = this.getAddonStorage(e);
          for (const a of Object.keys(s))
            ...
            else t && this.setAddonEnabled(e, null);
        }
        parseUrlParameter(e) {
          this.remote = !0;
          const t = e.split(",");
        ...
        export(e) {
          ...
          for (const [e, t] of Object.entries(a.a)) {
            const a = this.getAddonEnabled(e),
              o = {};
            if (t.settings)
              for (const { id: s } of t.settings)
                o[s] = this.getAddonSetting(e, s);
            s.addons[e] = { enabled: a, settings: o };
          }
          return s;
        }
        import(e) {
          for (const [t, s] of Object.entries(e.addons)) {
            if (!Object.prototype.hasOwnProperty.call(a.a, t)) continue;
        ...
        setStoreWithVersionCheck(e) {
          let { version: t, store: s } = e;
          t === o.commit && this.setStore(s);
        }
        setStore(e) {
          const t = this.store;
              ...
              (this.store[s] = JSON.parse(JSON.stringify(o))),
                this.dispatchEvent(
                  new CustomEvent("addon-changed", {
                    detail: { addonId: s, dynamicEnable: t, dynamicDisable: n },
                  })
                );
            }
          }
        ...
        evaluateCondition(e, t) {
          ...
          if (t.addonEnabled) {
            if (
              ((s = t.addonEnabled), Array.isArray(s) ? s : [s]).every(
                (e) => !this.getAddonEnabled(e)
              )
            )
              return !1;
          }
          var s;
          if (t.settings)
            for (const [s, a] of Object.entries(t.settings)) {
              if (
                !(Array.isArray(a) ? a : [a]).includes(
                  this.getAddonSetting(e, s)
                )
              )
                return !1;
            }
      ...
      m.has("addons")
        ? u.parseUrlParameter(m.get("addons"))
        : u.readLocalStorage();
      t.a = u;
    },
    256: function (e, t, s) {
      ...
      const d = "undefined" != typeof window && "ontouchstart" in window,
        c =
          "undefined" != typeof navigator &&
          navigator.clipboard &&
          navigator.clipboard.write,
        u = "undefined" != typeof MediaRecorder,
        m = {
          editorOnly: !0,
          ...
          dynamicDisable: !0,
          userscripts: [{ url: "userscript.js" }],
          userstyles: [{ url: "userscript.css" }],
          tags: ["recommended"],
          enabledByDefault: !0,
        };
      d && (m.enabledByDefault = !1);
      var p = m;
      var y = {
        editorOnly: !0,
        ...
        customCssVariables: [
          {
            ...
            value: {
              type: "map",
              source: { type: "settingValue", settingId: "toggle" },
              options: { hover: "flex", cathover: "flex", category: "none" },
            },
          },
          {
            ...
            value: {
              type: "map",
              source: { type: "settingValue", settingId: "toggle" },
              options: { hover: "block", cathover: "none", category: "none" },
            },
          },
        ],
        userscripts: [{ url: "userscript.js" }],
        ...
        settings: [
          {
            ...
            type: "select",
            potentialValues: [
              { id: "hover", name: "Palette area hover" },
              { id: "cathover", name: "Category hover" },
              { id: "category", name: "Category click" },
            ],
            default: "cathover",
          },
          {
        ...
        settings: [
          {
            ...
            type: "boolean",
            default: !1,
            if: { addonEnabled: "better-img-uploads" },
          },
        ],
        dynamicDisable: !0,
        tags: ["recommended"],
      ...
      var S = {
        ...
        userstyles: [
          { url: "userstyle.css" },
          { url: "hover.css", if: { settings: { always: !1 } } },
        ],
        settings: [
          {
            name: "Default volume",
      ...
      var T = {
        ...
        tags: ["recommended"],
        credits: [{ name: "Richie Bendall" }, { name: "apple502j" }],
        userscripts: [{ url: "userscript.js" }],
        userstyles: [{ url: "style.css" }],
        dynamicDisable: !0,
        enabledByDefault: !0,
      ...
      var A = {
        ...
        settings: [
          ...
          },
          {
            ...
            default: "merge",
            potentialValues: [
              { id: "merge", name: "Merge images" },
              { id: "tint", name: "Color tint" },
            ],
          },
          {
        ...
        settings: [
          {
            ...
            type: "select",
            potentialValues: [
              { id: "full", name: "Original size" },
              { id: "fill", name: "Stretch to fill canvas" },
              { id: "fit", name: "Shrink to fit canvas" },
            ],
            default: "fit",
          },
        ],
        ...
        presets: [
          {
            ...
            values: { paddingSize: 100, cornerSize: 100, notchSize: 100 },
          },
          {
            name: "2.0 Blocks",
            id: "default2",
            description: "An appearance similar to Scratch 2.0 blocks",
            values: { paddingSize: 70, cornerSize: 150, notchSize: 75 },
          },
          {
            name: "3.0 Flat",
            id: "flat3",
            description: "Scratch 3.0 blocks with notches and corners removed",
            values: { paddingSize: 100, cornerSize: 0, notchSize: 0 },
          },
          {
            name: "2.0 Flat",
            id: "flat2",
            description: "Scratch 2.0 blocks with notches and corners removed",
            values: { paddingSize: 70, cornerSize: 0, notchSize: 0 },
          },
        ],
      };
      var I = {
        ...
        settings: [
          ...
          { name: "Number inputs", id: "number", type: "boolean", default: !1 },
        ],
        dynamicDisable: !0,
      };
      var L = {
        ...
        settings: [
          {
            ...
            type: "select",
            potentialValues: [
              { name: "Lighter", id: "lighter" },
              { name: "Darker", id: "darker" },
            ],
            default: "lighter",
          },
          {
        ...
        customCssVariables: [
          {
            ...
            value: {
              type: "map",
              source: { type: "settingValue", settingId: "shade" },
              options: { lighter: "1", darker: "-1" },
            },
          },
        ],
        dynamicDisable: !0,
      ...
      var R = {
        ...
        userstyles: [
          { url: "userstyle.css" },
          { url: "hide-labels.css", if: { settings: { hideLabels: !0 } } },
          {
            url: "sprite-properties.css",
            if: { addonEnabled: ["sprite-properties"] },
          },
        ],
        userscripts: [{ url: "userscript.js" }],
        settings: [
      ...
      var N = {
        ...
        settings: [
          {
            ...
            type: "select",
            potentialValues: [
              { name: "Icons and labels", id: "both" },
              { name: "Icons only", id: "icons" },
              { name: "Labels only", id: "labels" },
            ],
            default: "both",
          },
        ],
        userstyles: [
          {
            url: "menu-icons.css",
            if: { settings: { "menu-labels": "icons" } },
          },
          {
            url: "menu-labels.css",
            if: { settings: { "menu-labels": "labels" } },
          },
        ],
        dynamicDisable: !0,
        enabledByDefault: !1,
      ...
      var H = {
        ...
        customCssVariables: [
          {
            ...
            value: {
              type: "textColor",
              source: { type: "settingValue", settingId: "comment-color" },
            },
          },
          {
        ...
        dynamicDisable: !0,
        userscripts: [{ url: "theme3.js" }],
        userstyles: [
          { url: "theme3.css" },
          { url: "black_text.css", if: { settings: { text: "black" } } },
          {
            url: "color_on_white.css",
            if: { settings: { text: "colorOnWhite" } },
          },
          {
            url: "color_on_black.css",
            if: { settings: { text: "colorOnBlack" } },
          },
        ],
        settings: [
          {
          ...
          },
          {
            ...
            potentialValues: [
              { id: "white", name: "White" },
              { id: "black", name: "Black" },
              { id: "colorOnWhite", name: "Colored on white background" },
              { id: "colorOnBlack", name: "Colored on black background" },
            ],
          },
        ],
        tags: ["theme"],
        ...
        customCssVariables: [
          {
            ...
            value: {
              type: "map",
              source: { type: "settingValue", settingId: "transitionDuration" },
              options: {
                none: "0s",
                short: "0.15s",
                default: "0.25s",
      ...
      var ee = {
        ...
        settings: [
          ...
          },
          {
            ...
            default: "defOnly",
            potentialValues: [
              { id: "defOnly", name: "Parameters in own custom block" },
              { id: "all", name: "Parameters in all custom blocks in sprite" },
            ],
            if: { settings: { customargs: !0 } },
          },
          {
            dynamic: !0,
      ...
      var te = {
        ...
        userscripts: [{ url: "userscript.js" }],
        settings: [
          { name: "Music", id: "music", type: "boolean", default: !0 },
          { name: "Pen", id: "pen", type: "boolean", default: !0 },
          {
            name: "Text to Speech",
            id: "text2speech",
            type: "boolean",
          ...
          { name: "Translate", id: "translate", type: "boolean", default: !1 },
        ],
        dynamicDisable: !0,
        tags: [],
      };
      ...
      var oe = {
        ...
        settings: [
          ...
          },
          {
            ...
            default: "randomize",
            potentialValues: [
              { id: "custom", name: "Specified x/y position" },
              { id: "keep", name: "Same as original sprite" },
      ...
      var ie = {
        ...
        enabledByDefault: !1,
        dynamicDisable: !0,
        userstyles: [{ url: "remove-borders.css" }],
      };
      var re = {
        editorOnly: !0,
        noTranslations: !0,
      ...
      var me = {
        ...
        userstyles: [
          { url: "sprites.css", if: { settings: { sprites: !0 } } },
          { url: "costumes.css", if: { settings: { costumes: !0 } } },
          { url: "sounds.css", if: { settings: { sounds: !0 } } },
        ],
      };
      var pe = {
        editorOnly: !0,
        ...
        settings: [
          {
            ...
            potentialValues: [
              { id: "none", name: "None" },
              { id: "hundredth", name: "0.01" },
              { id: "tenth", name: "0.1" },
              { id: "one", name: "1" },
              { id: "ten", name: "10" },
            ],
            if: { settings: { useCustom: !1 } },
          },
          {
            dynamic: !0,
            name: "Change on regular key press",
        ...
        customCssVariables: [
          {
            ...
            value: {
              type: "ternary",
              source: { type: "settingValue", settingId: "upscale" },
              true: "95%",
              false: "32px",
            },
          },
      ...
      var Te = {
        ...
        presets: [
          { name: "Whole-block", id: "whole-block", values: { grid: 48 } },
          { name: "Half-block", id: "half-block", values: { grid: 24 } },
          { name: "Default", id: "default", values: { grid: 40 } },
        ],
        dynamicDisable: !0,
        enabledByDefault: !1,
      };
      var je = {
        ...
        userstyles: [
          ...
          { url: "resizeWindow.css", if: { settings: { toolbar: "show" } } },
          {
            url: "resizeWindow_noToolbar.css",
            if: { settings: { toolbar: ["hide", "hover"] } },
          },
          {
            url: "hideToolbar.css",
            if: { settings: { toolbar: ["hide", "hover"] } },
      ...
      var Fe = {
        ...
        userscripts: [{ url: "remove-backpack.js" }],
        userstyles: [{ url: "remove-backpack.css" }],
        tags: ["danger"],
        dynamicDisable: !0,
        enabledByDefault: !1,
      };
      var Be = {
          ...
          userstyles: [{ url: "remove-feedback.css" }],
          tags: ["danger"],
          dynamicDisable: !0,
          enabledByDefault: !1,
        },
      ...
      t.a = {
        ...
        "jump-to-def": r,
        "reorder-custom-inputs": l,
        "editor-searchable-dropdowns": p,
        "data-category-tweaks-v2": y,
        "block-palette-icons": h,
        "hide-flyout": b,
        mediarecorder: g,
        "drag-drop": k,
        debugger: v,
        ...
        "mouse-pos": x,
        "color-picker": T,
        "remove-sprite-confirm": j,
        "block-count": O,
        "onion-skinning": A,
        "paint-snap": F,
        "default-costume-editor-color": B,
        "bitmap-copy": M,
        "2d-color-picker": _,
        "paint-skew": P,
        "better-img-uploads": z,
        "pick-colors-from-stage": G,
        "custom-block-shape": V,
        "editor-square-inputs": I,
        "zebra-striping": L,
        "editor-compact": R,
        "custom-menu-bar": N,
        "editor-theme3": H,
        "custom-block-text": U,
        "editor-colored-context-menus": W,
        "editor-stage-left": J,
        "editor-buttons-reverse-order": K,
        "variable-manager": q,
        "search-sprites": Z,
        "sprite-properties": Y,
        gamepad: Q,
        ...
        "custom-zoom": se,
        "copy-reporter": ae,
        "initialise-sprite-position": oe,
        blocks2image: ne,
        "remove-curved-stage-border": ie,
        "transparent-orphans": re,
        "paint-by-default": le,
        "block-cherry-picking": de,
        "hide-new-variables": ce,
        "editor-extra-keys": ue,
        "hide-delete-button": me,
        "no-script-bumping": pe,
        "disable-stage-drag-select": ye,
        "move-to-top-bottom": he,
        "move-to-top-layer": be,
        "disable-paste-offset": fe,
        "block-duplicate": ge,
        "rename-broadcasts": ke,
        "swap-local-global": ve,
        "editor-comment-previews": we,
        columns: De,
        "number-pad": Se,
        "editor-number-arrow-keys": Ce,
        "expanded-backpack": xe,
        "script-snap": Te,
        fullscreen: je,
        "hide-stage": Oe,
        "tw-straighten-comments": Ae,
        "tw-remove-backpack": Fe,
        "tw-remove-feedback": Be,
        "tw-disable-cloud-variables": _e,
        "tw-disable-compiler": Pe,
        "editor-stepping": ze,
      };
    },
    550: function (e) {
      e.exports = JSON.parse('{"commit":"df5f51e"}');
    },
    707: function (e, t, s) {
      "use strict";
      t.a = class {
...
//# sourceMappingURL=addon-settings~addons~editor~fullscreen~player.5e69a2514b45b77b90c4.js.map
