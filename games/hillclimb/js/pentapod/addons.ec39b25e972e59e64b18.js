(window.webpackJsonpGUI = window.webpackJsonpGUI || []).push([
  [82],
  {
    1371: function (e, t, n) {
      ...
      const u = () => r,
        p = (e) => {
          if (e.updateMonitor || a.has(e)) return;
          const t = { time: s.runtime.currentMSecs, status: e.status };
          a.set(e, t), (e.status = 1);
        },
        g = (e) => {
          ...
          e.timer && (e.timer.startTime += s.runtime.currentMSecs - t.time),
            e.compatibilityStackFrame &&
              ...
              (e.compatibilityStackFrame.timer.startTime +=
                s.runtime.currentMSecs - t.time);
          const n = e.peekStackFrame();
          n &&
            n.executionContext &&
            n.executionContext.timer &&
            (n.executionContext.timer.startTime +=
              s.runtime.currentMSecs - t.time);
        },
        m = (e) => {
          const t = r !== e;
          if (
            (t &&
              ...
              r
                ? s.runtime.emit("RUNTIME_PAUSED")
                : s.runtime.emit("RUNTIME_UNPAUSED")),
            r)
          ) {
            (d = d.then(() => s.runtime.audioEngine.audioContext.suspend())),
              s.runtime.ioDevices.clock._paused ||
                s.runtime.ioDevices.clock.pause(),
              ...
              if (-1 !== n)
                for (let e = n; e < t.length; e++) {
                  const n = t[e],
                    o = n.status;
                  (0 !== o && 2 !== o && 3 !== o) ||
                    ((s.runtime.sequencer.activeThread = n),
                    s.runtime.sequencer.stepThread(n));
                }
            })(c),
              (c = null);
          }
        ...
        C = (e) => {
          ...
          for (let n = e; n < t.length; n++) {
            const e = t[n];
            if (e.updateMonitor) continue;
            if (e.isCompiled) continue;
            const o = v(e);
            if (0 === o || 2 === o || 3 === o) return p(e), e;
          }
          return null;
        },
        M = () => {
          if (c) {
            const e = a.get(c);
            b(c, e), (e.time = s.runtime.currentMSecs);
            ((e) => {
              if (4 === e.status) return !1;
              if (e.isCompiled) return !1;
              const t = e.peekStack();
              if (!t && (e.popStack(), 0 === e.stack.length))
                return (e.status = 4), !1;
              (i = !0), (s.runtime.sequencer.activeThread = e);
              const n = [
          ...
          if (!c) {
            h(C(0)),
              (s.runtime.ioDevices.clock._pausedTime +=
                s.runtime.currentStepTime);
            ...
            for (const t of s.runtime.targets)
              for (const n of Object.keys(t.sprite.soundBank.soundPlayers)) {
                ...
                o.outputNode &&
                  (o.outputNode.stop(e.currentTime),
                  o._createSource(),
                  o.outputNode.start(
                    e.currentTime,
                    e.currentTime -
                      o.startingUntil +
                      s.runtime.currentStepTime / 1e3
                  ),
                  (o.startingUntil -= s.runtime.currentStepTime / 1e3));
              }
            for (const e of s.runtime.threads)
    ...
    1376: function (e, t, n) {
      ...
      function s(e) {
        return 1 === (e = Math.round(e).toString(16)).length
          ? "0".concat(e)
          : e;
      }
      function r(e) {
      ...
      function a(e) {
        let { r: t, g: n, b: o } = e;
        (t /= 255), (n /= 255), (o /= 255);
        const s = Math.max(t, n, o),
          r = s - Math.min(t, n, o);
        if (0 === r) return { h: 0, s: 0, v: s };
        const a = (s - t) / r,
          i = (s - n) / r,
          c = (s - o) / r;
        let l;
        a ? (i ? c || (l = 4 + i - a) : (l = 2 + a - c)) : (l = c - i);
        return { h: (60 * l) % 360, s: r / s, v: s };
      }
      function i(e) {
        const { r: t, g: n, b: s } = o(e);
        return 0.299 * t + 0.587 * n + 0.114 * s;
      }
      function c(e, t, n, o) {
        return (
          "number" != typeof (o = void 0 !== o ? o : 170) && (o = i(o)),
          i(e) > o
            ? void 0 !== t
              ? t
              : "#575e75"
      ...
      function l(e, t) {
        ...
        return (
          ...
          void 0 === t.b && (t.b = 1),
          void 0 === t.a && (t.a = 1),
          r({ r: t.r * n, g: t.g * s, b: t.b * a, a: t.a * i })
        );
      }
      function d(e, t) {
        const { r: n, g: s, b: a, a: i } = o(e);
      ...
      function g(e, t, n) {
        return r(
          (function (e) {
            let { h: t, s: n, v: o } = e;
            if (0 === n) return { r: 255 * o, g: 255 * o, b: 255 * o };
            (t %= 360), t < 0 && (t += 360);
            const s = t / 60,
              r = Math.floor(s),
              a = o * (1 - n * (1 - s + r)),
            ...
            switch (r) {
              ...
              case 2:
                return { r: 255 * c, g: 255 * o, b: 255 * a };
              case 3:
                return { r: 255 * c, g: 255 * i, b: 255 * o };
              case 4:
                return { r: 255 * a, g: 255 * c, b: 255 * o };
              case 5:
                return { r: 255 * o, g: 255 * c, b: 255 * i };
            }
          })({
            h: "number" == typeof e ? e : a(o(e)).h,
            s:
              "number" != typeof e && 0 === a(o(e)).s
                ? 0
                : "number" == typeof t
                ? t
                : a(o(t)).s,
            v: "number" == typeof n ? n : a(o(n)).v,
          })
        );
      }
      function h(e) {
      ...
      class s {
        static flash(e) {
          r.timerID > 0 &&
            ...
            r.block.svgPath_ && (r.block.svgPath_.style.fill = ""));
          let t = 4,
            n = !0;
          (r.block = e),
            (function e() {
              r.block.svgPath_ &&
                (r.block.svgPath_.style.fill = n ? "#ffff80" : ""),
                (n = !n),
                t--,
                t > 0
                  ? (r.timerID = setTimeout(e, 200))
                  : ((r.timerID = 0), (r.block = null));
            })();
        }
      }
      const r = { block: null, timerID: null };
      let a = [],
        i = [];
      class c {
        constructor(e) {
        ...
        scrollBlockIntoView(e) {
          ...
          if (
            (e instanceof o.a
              ? (this.setEditingTarget(e.targetId), (n = r.getBlockById(e.id)))
              : (n = e && e.id ? e : r.getBlockById(e)),
            !n)
          )
            return;
          let a = n.getRootBlock(),
            ...
            h = r.getMetrics();
          if (
            d < h.viewLeft + this.offsetX - 4 ||
            p > h.viewLeft + h.viewWidth ||
            u < h.viewTop + this.offsetY - 4 ||
            g > h.viewTop + h.viewHeight
          ) {
            ...
            this.navigationHistory.storeView(this.navigationHistory.peek(), 64),
              r.scrollbar.set(e, t),
              this.navigationHistory.storeView({ left: e, top: t }, 64);
          }
      ...
      class l {
        storeView(e, t) {
          ...
          let n = Blockly.getMainWorkspace().getMetrics(),
            o = { left: n.viewLeft, top: n.viewTop };
          (!e || d(o, e) > t) && a.push(o);
        }
        peek() {
        ...
        goBack() {
          const e = Blockly.getMainWorkspace(),
            t = e.getMetrics();
          let n = { left: t.viewLeft, top: t.viewTop },
            o = this.peek();
          if (!o) return;
          if (
            (d(n, o) < 64 && a.length > 1 && (a.pop(), i.push(o)),
            (o = this.peek()),
            !o)
          )
            return;
          let s = o.left - t.contentLeft,
            r = o.top - t.contentTop;
          e.scrollbar.set(s, r);
        }
        goForward() {
          let e = i.pop();
    ...
    1384: function (e, t, n) {
      ...
      class o {
        constructor(e, t) {
          (this.targetId = e.id), (this.id = t.id);
        }
      }
    },
    1385: function (e, t, n) {
    ...
    1401: function (e, t, n) {
      ...
      const l = function (e) {
          ...
          const g = {};
          if (
            null === (t = d[this.traps.getInternalKey(d)]) ||
            void 0 === t ||
            null === (n = t.return) ||
            void 0 === n ||
            null === (o = n.return) ||
          ...
          {
            const e =
              d[this.traps.getInternalKey(d)].return.return.return.stateNode
                .props;
          ...
          const h = s({ menuItem: p, target: d, type: u }, g);
          Array.from(p.children).forEach((e) => {
            e.classList.contains("sa-ctx-menu") && e.remove();
          });
          for (const e of i
            ? c.flatMap((e) => ("function" == typeof e ? e(u, h) : e))
            : c) {
            if (!e) continue;
            if (e.types && !e.types.some((e) => u === e)) continue;
            if (e.condition && !e.condition(h)) continue;
            ...
            (o.textContent = e.label),
              t.append(o),
              this.displayNoneWhileDisabled(t, { display: "block" }),
              t.addEventListener("click", (t) => {
                t.stopPropagation(),
                  window.dispatchEvent(
                    new CustomEvent("REACT_CONTEXTMENU_HIDE", {
                      detail: { action: "REACT_CONTEXTMENU_HIDE" },
                    })
                  ),
                  e.callback(h);
              }),
        ...
        d = (e) => {
          a ||
            ((a = !0),
            document.body.addEventListener("contextmenu", (t) => l.call(e, t), {
              capture: !0,
            }));
        },
        u = (e, t, n) => {
    ...
    1402: function (e, t, n) {
      ...
      const i = function (e, t) {
          ...
          (o.style.display = n ? "" : "none"), document.body.appendChild(o);
        ...
        c = (e) => {
          ...
          return (
            t.appendChild(o), { buttonRow: t, cancelButton: n, okButton: o }
          );
        },
        l = function (e, t, n) {
          let { useEditorClasses: o = !1 } =
          ...
          "editor" === d &&
            (r.classList.add(e.scratchClass("prompt_modal-content")),
            a.classList.add(e.scratchClass("prompt_body"))),
            a.appendChild(
              Object.assign(document.createElement("div"), {
        ...
        d = function (e, t, n) {
          ...
          i.appendChild(u), u.focus(), u.select();
    ...
    1405: function (e, t, n) {
      ...
      (o.style.display = "none"),
        (o.className = "addons-styles"),
        document.body.appendChild(o);
      const s = new Map(),
        r = () => {
          for (const e of s.values()) e.update();
        };
      class a {
        constructor(e) {
          (this.el = null),
        ...
        addDependent(e, t, n) {
          this.dependents.push([e, n]),
            t > this.precedence &&
              ((this.precedence = t),
              this.el && (this.el.dataset.precedence = t)),
            this.update();
        }
        getEnabledDependents() {
          const e = [];
          for (const [t, n] of this.dependents) n() && e.push(t);
          return e;
        }
        dependsOn(e) {
          return this.dependents.some((t) => t[0] === e);
        }
        getElement() {
          if (!this.el) {
            const e = document.createElement("style");
            (e.className = "scratch-addons-style"),
              (e.dataset.precedence = this.precedence),
              (e.textContent = this.styleText),
              (this.styleText = null),
              (this.el = e);
          }
          return this.el;
        ...
        update() {
          const e = this.getEnabledDependents();
          if (
            !((e, t) => {
              if (e.length !== t.length) return !1;
              for (let n = 0; n < e.length; e++) if (e[n] !== t[n]) return !1;
              return !0;
            })(e, this.previousEnabledDependents)
          )
            if (((this.previousEnabledDependents = e), e.length > 0)) {
              const t = this.getElement();
              t.dataset.addons = e.join(",");
              for (const e of o.children) {
                if ((+e.dataset.precedence || 0) >= this.precedence)
                  return void o.insertBefore(t, e);
              }
              o.appendChild(t);
            } else this.el && this.el.remove();
        }
      }
      const i = (e, t) => {
        if (!s.get(e)) {
    ...
    1406: function (e, t, n) {
      "use strict";
      const o = ["columns", "editor-stage-left", "editor-theme3", "hide-stage"];
      t.a = (e) => o.indexOf(e) + 1;
    },
    1407: function (e, t, n) {
      "use strict";
      ...
      class r extends o.a {
        constructor() {
          super(),
            ...
            (s.a.appStateReducer = (e, t, n) => {
              (this._isInReducer = !0),
                (this._nextState = n),
                this.dispatchEvent(
                  new CustomEvent("statechanged", {
                    detail: { action: e, prev: t, next: n },
                  })
                ),
                (this._nextState = null),
                (this._isInReducer = !1);
        ...
        dispatch(e) {
          this._isInReducer
            ? queueMicrotask(() => s.a.appStateStore.dispatch(e))
            : s.a.appStateStore.dispatch(e);
        }
        get state() {
          return this._nextState
            ? this._nextState
            : s.a.appStateStore.getState();
        }
      }
      const a = new r();
      t.a = a;
    ...
    1519: function (e, t, n) {
      ...
      var o = n(1371),
        s = n(1400);
      const r = {
        "userscript.js": async function (e) {
          let { addon: t, console: n, msg: s } = e;
          Object(o.f)(t);
          const r = document.createElement("img");
          (r.className = "pause-btn"),
            (r.draggable = !1),
            (r.title = s("pause"));
          const a = () => {
            (r.src = t.self.getResource(
              Object(o.b)() ? "/play.svg" : "/pause.svg"
            )),
              (r.title = Object(o.b)() ? s("play") : s("pause"));
          };
          for (
            r.addEventListener("click", () => Object(o.e)(!Object(o.b)())),
              t.tab.displayNoneWhileDisabled(r),
              t.self.addEventListener("disabled", () => Object(o.e)(!1)),
              a(),
              Object(o.c)(a),
              document.addEventListener(
                ...
                function (e) {
                  !e.altKey ||
                    ("x" !== e.key.toLowerCase() && 88 !== e.keyCode) ||
                    t.self.disabled ||
                    (e.preventDefault(),
                    e.stopImmediatePropagation(),
                    Object(o.e)(!Object(o.b)()));
                },
                { capture: !0 }
              );
            ;
            ...
            await t.tab.waitForElement("[class^='green-flag']", {
              markAsSeen: !0,
              reduxEvents: [
    ...
    1525: function (e, t, n) {
      ...
      const s = {
        "userscript.js": async function (e) {
          let { addon: t, console: n } = e;
          const s = t.tab.traps.vm;
          Object(o.g)(s);
          const r = document.createElement("img");
          (r.loading = "lazy"),
            (r.src = t.self.getResource("/mute.svg")),
            (r.className = "sa-mute-project-icon"),
            (r.style.userSelect = "none"),
            t.tab.displayNoneWhileDisabled(r);
          const a = () => {
            r.style.display = t.self.disabled || !Object(o.b)() ? "none" : "";
          };
          Object(o.c)(a), a();
          const i = (e) => {
            t.self.disabled ||
          ...
          for (
            ...
            let e = await t.tab.waitForElement(
    ...
    1533: function (e, t, n) {
      ...
      const s = {
        "userscript.js": async function (e) {
          let { addon: t, msg: n, console: s } = e;
          const r = new o.a(t),
            a = await t.tab.traps.getBlockly();
          Object.defineProperty(a.Gesture.prototype, "jumpToDef", {
            get: () => !t.self.disabled,
          });
          const i = a.Gesture.prototype.doBlockClick_;
          a.Gesture.prototype.doBlockClick_ = function () {
            if (
              !t.self.disabled &&
              (1 === this.mostRecentEvent_.button ||
              ...
              for (; e; e = e.getSurroundParent())
                if ("procedures_call" === e.type) {
                  let t = e.getProcCode(),
                    n = r.getWorkspace().getTopBlocks();
                  for (const e of n)
                    if ("procedures_definition" === e.type) {
                      let n = e.getChildren()[0].getProcCode();
                      if (n && n === t) return void r.scrollBlockIntoView(e);
                    }
                }
            }
            i.call(this);
          ...
          document.addEventListener(
            ...
            (e) => {
              ...
              if (
                ...
                (s = e.target.closest('div[class*="selector_wrapper"]'))
                  ? (i = (e) => {
                      const n = t.settings.get("use-hd-upload")
                          ? ""
                          : ":not(.sa-better-img-uploads-input)",
                        o = s.querySelector(
                          'input[class*="action-menu_file-input"]' + n
                        );
                      (o.files = e),
                        o.dispatchEvent(new Event("change", { bubbles: !0 }));
                    })
                  : (s = e.target.closest('div[class*="monitor_list-monitor"]'))
                  ? (i = (e) => {
                  ...
                  : (s = e.target.closest(
                    ...
                    (i = async (e) => {
                      const t = (
                          await Promise.all(Array.from(e, (e) => e.text()))
                        )
                          .join("")
                          .replace(/[\r\n]+$/, "")
                          .replace(/\r?\n|\r/g, " "),
                      ...
                      ((e, t) => {
                        ...
                        s,
                        s.value.slice(0, n) + t + s.value.slice(s.selectionEnd)
                      ),
                        s.setSelectionRange(n, n + t.length);
                    }),
                !s)
              )
                return;
              if ((e.preventDefault(), s === o)) return;
              o = s;
              const c = [
                s,
                s.querySelector('div[class*="stage-selector_header_"]'),
                s.querySelector('div[class*="sprite-info_sprite-info"]'),
                s.querySelector('div[class*="monitor_list-body"]'),
              ].filter((e) => e);
              for (const e of c) r(e, 1);
              const l = (e) => {
                  e.preventDefault(),
                    p(),
              ...
              const u = (e) => {
                ...
                p = () => {
                  (o = null),
                    s.removeEventListener("dragover", d),
                    s.removeEventListener("dragleave", u),
                    s.removeEventListener("drop", l);
                  for (const e of c) r(e, -1);
                };
    ...
    656: function (e, t, n) {
      ...
      n.r(t),
        function (e) {
          ...
          const y = (e) =>
              e.replace(/([<>'"&])/g, (e, t) =>
                "&#".concat(t.charCodeAt(0), ";")
              ),
            k = (e) => e.replace(/-([a-z])/g, (e) => e[1].toUpperCase());
          let v = null;
          let w,
            C = [];
          const M = (e) => {
            ...
            E = (() => {
              const e = f.a.state.locales.locale;
              return Object.prototype.hasOwnProperty.call(d.a, e)
                ? e
                : e.split("-")[0];
            })(),
            _ = (async () => {
              if (Object.prototype.hasOwnProperty.call(d.a, E)) {
                const e = await d.a[E]();
                Object.assign(l, e);
              }
            })(),
          ...
          const j = () => {
            const e = f.a.state,
              t = "small" === e.scratchGui.stageSize.stageSize,
              n = e.scratchGui.mode.isFullScreen,
              o = e.scratchGui.mode.isPlayerOnly;
            document.body.classList.toggle("sa-small-stage", t && !n && !o),
              document.body.classList.toggle("sa-body-editor", !o || n);
          };
          f.a.addEventListener("statechanged", (e) => {
            ("scratch-gui/StageSize/SET_STAGE_SIZE" !== e.detail.action.type &&
              "scratch-gui/mode/SET_FULL_SCREEN" !== e.detail.action.type &&
              "scratch-gui/mode/SET_PLAYER" !== e.detail.action.type) ||
              j();
          }),
            j();
          const O = (e) =>
            Object.keys(e).find((e) =>
          ...
          class L extends a.a {
            constructor(e) {
              super(),
                ...
                (this.traps = {
                  get vm() {
                    return f.a.state.scratchGui.vm;
                  },
                  getBlockly: () =>
                    i.a.blockly
                      ? Promise.resolve(i.a.blockly)
                      : new Promise((e) => {
                          i.a.blocklyCallbacks.push(() => e(i.a.blockly));
                        }),
                  getWorkspace: () => i.a.blocklyWorkspace,
                  getPaper: async () => {
                    const e = await this.waitForElement(
            ...
            waitForElement(e) {
              ...
              return (
                s &&
                  ...
                  (i = (e) => {
                    let { detail: t } = e;
                    const n = t.action.type;
                    s.includes(n) &&
                      "fontsLoaded/SET_FONTS_LOADED" !== n &&
                      (r = !0);
                  }),
                  this.redux.initialize(),
                  this.redux.addEventListener("statechanged", i)),
                new Promise((n) => {
                  const o = () => {
                    if (!a()) return;
                    ...
                    for (const e of s)
                      if (!this._seenElements.has(e)) {
                        n(e),
                          ...
                          i &&
                            this.redux.removeEventListener("statechanged", i);
                        break;
                      }
                  };
                  var s;
            ...
            appendToSharedSpace(e) {
              let { space: t, element: n, order: o, scope: s } = e;
              const r = document.querySelector.bind(document),
                a = {
                  stageHeader: {
                    element: () => r("[class^='stage-header_stage-size-row']"),
                    from: () => [],
                    until: () => [
                      r("[class^='stage-header_stage-size-toggle-group']"),
                      r("[class^='stage-header_stage-size-row']").lastChild,
                    ],
                  },
                  fullscreenStageHeader: {
                    element: () =>
                      r("[class^='stage-header_fullscreen-buttons-row_']"),
                    from: () => [],
                    until: () => [
                      r("[class^='stage-header_fullscreen-buttons-row_']")
                        .lastChild,
                  ...
                  afterGreenFlag: {
                    element: () => r("[class^='controls_controls-container']"),
                    from: () => [],
                    until: () => [r("[class^='stop-all_stop-all']")],
                  },
                  afterStopButton: {
                    element: () => r("[class^='controls_controls-container']"),
                    from: () => [r("[class^='stop-all_stop-all']")],
                    until: () => [],
                  },
                  afterSoundTab: {
                    element: () =>
                      r("[class^='react-tabs_react-tabs__tab-list']"),
                    from: () => [
                      r("[class^='react-tabs_react-tabs__tab-list']")
                        .children[2],
                    ],
                  ...
                  monitor: {
                    ...
                    from: () => {
                      const e = [
                        ...
                        t = Array.prototype.filter.call(s.children, (t) =>
                  ...
                  paintEditorZoomControls: {
                    element: () =>
                      r(".sa-paintEditorZoomControls-wrapper") ||
                      (() => {
                        ...
                        const t = r("[class^='paint-editor_zoom-controls']");
              ...
              const c = a.from(),
                l = a.until();
              n.dataset.saSharedSpaceOrder = o;
              let d = !1;
              0 === c.length && (d = !0);
              let u = null;
              const p = Array.from(i.children);
              for (const e of p.keys()) {
                ...
                if (d) {
                  ...
                  if (
                    ...
                    Number(t.dataset.saSharedSpaceOrder) > o
                  ) {
                    u = 0 === n ? -1 : p[n - 1];
                    break;
                  }
                } else c.includes(t) && (d = !0);
              }
              return (
                !!d &&
                (null === u
                  ...
                  : -1 === u
                  ? i.prepend(n)
                  : i.insertBefore(n, u.nextSibling),
                !0)
              );
            }
            addBlock(e, t) {
              let { args: n, displayName: o, callback: s } = t;
              const r = S(e);
                ...
                (a = r),
                  ...
                  JSON.stringify(a) !== JSON.stringify(i) &&
                    (console.warn(
                      "displayName "
                        .concat(o, " for ")
                        .concat(e, " has invalid arguments, ignoring it.")
                    ),
                    (o = e));
              } else o = e;
              var a, i;
              const c = this.traps.vm;
              c.addAddonBlock({
                procedureCode: e,
                arguments: n,
                callback: (e, t) => s(e, t.thread),
                displayName: o,
              }),
                N ||
                  ((N = !0),
                  this.traps.getBlockly().then((e) => {
                    const t = e.BlockSvg,
                      n = t.prototype.updateColour;
                    t.prototype.updateColour = function () {
                      if (
                        !this.isInsertionMarker() &&
                        "procedures_call" === this.type
                      ) {
                        if (
                          this.procCode_ &&
                          c.runtime.getAddonBlock(this.procCode_)
                        ) {
                          const e =
                            f.a.state.scratchGui.theme.theme.getBlockColors()
                              .addons;
                          (this.colour_ = e.primary),
                            (this.colourSecondary_ = e.secondary),
                            (this.colourTertiary_ = e.tertiary),
                            (this.colourQuaternary_ = e.quaternary),
                    ...
                    (e.Blocks.procedures_call.createAllInputs_ = function () {
                      const e =
                        this.procCode_ &&
                        c.runtime.getAddonBlock(this.procCode_);
                      for (
                        ...
                        n[s] = arguments[s];
                      if (e && e.displayName) {
                        const t = this.procCode_;
                        this.procCode_ = e.displayName;
                        const s = o.call(this, ...n);
                        return (this.procCode_ = t), s;
                      }
                      return o.call(this, ...n);
                    }),
                      c.editingTarget && c.emitWorkspaceUpdate();
                  }));
            }
            getCustomBlock(e) {
              return this.traps.vm.getAddonBlock(e);
            }
            createBlockContextMenu(e) {
              let {
                workspace: t = !1,
                blocks: n = !1,
                flyout: o = !1,
              ...
              T.push({
                ...
                T.sort((e, t) => I.indexOf(e.addonId) - I.indexOf(t.addonId)),
                D ||
                  ((D = !0),
                  this.traps.getBlockly().then((e) => {
            ...
            copyImage(e) {
              ...
              const t = [new ClipboardItem({ "image/png": Object(r.a)(e) })];
              return navigator.clipboard.write(t);
            }
            scratchMessage(e) {
              return f.a.state.locales.messages[e];
            }
            scratchClassReady() {
            ...
            scratchClass() {
              const e = (() => {
                  ...
                  const e = Array.from(document.styleSheets)
                    .filter(
                      (e) =>
                        !(
                          e.ownerNode.textContent.startsWith(
                            "/* DO NOT EDIT\n@todo This file is copied from GUI and should be pulled out into a shared library."
                          ) &&
                          (e.ownerNode.textContent.includes(
                            "input_input-form"
                          ) ||
                            e.ownerNode.textContent.includes(
                              "label_input-group_"
                  ...
                  const t = new MutationObserver((e) => {
                    for (const n of e)
                      for (const e of n.addedNodes)
                        if ("STYLE" === e.tagName)
                          return (v = null), void t.disconnect();
                  });
                  return t.observe(document.head, { childList: !0 }), v;
                })(),
                t = [];
              for (
              ...
              if ("object" == typeof r) {
                const e = Array.isArray(r.others) ? r.others : [r.others];
            ...
            get editorMode() {
              return (() => {
                const e = f.a.state.scratchGui.mode;
                return e.isEmbedded
                  ? "embed"
                  : e.isFullScreen
                  ? "fullscreen"
            ...
            displayNoneWhileDisabled(e, t) {
              e.classList.add(x(this._id)),
                t && t.display && (e.style.display = t.display);
            }
            get direction() {
            ...
            recolorable() {
              ...
              let t = "";
              const n = () => {
                const n = t.replace(/#855cd6/gi, window.Recolor.primary);
              ...
              return (
                Object.defineProperty(e, "src", {
                  get: () =>
                    t
                      ? "data:image/svg+xml;,".concat(encodeURIComponent(t))
                      : "",
                  set: (e) => {
                    const o = e.split(";base64,")[1];
                    (t = atob(o)), n();
                  },
                }),
                i.a.recolorCallbacks.push(n),
                e
              );
            }
          }
          class A extends a.a {
            constructor(e, t) {
              super(), (this._addonId = e), (this._manifest = t);
            }
            get(e) {
          ...
          class P {
              ...
              (this.id = t),
                ...
                (this.publicAPI = {
                  ...
                  addon: {
                    tab: new L(t),
                    settings: new A(t, n),
                    self: new z(t, this.getResource.bind(this)),
                  },
            ...
            _msg(e, t, n) {
              ...
              if (this.messageCache[s]) return this.messageCache[s].format(t);
              let r = l[s];
              if (!r) return s;
              n && (r = n(r));
              const a = new o.a(r, E);
            ...
            evaluateCustomCssVariable(e) {
              ...
              switch (e.type) {
                case "alphaBlend": {
                  const t = this.evaluateCustomCssVariable(e.opaqueSource),
                    n = this.evaluateCustomCssVariable(e.transparentSource);
                  return h.a(t, n);
                }
                case "alphaThreshold": {
                  const t = this.evaluateCustomCssVariable(e.source);
                  return h.e(t).a >=
                    (this.evaluateCustomCssVariable(e.threshold) || 0.5)
                    ? this.evaluateCustomCssVariable(e.opaque)
                    : this.evaluateCustomCssVariable(e.transparent);
                }
                case "brighten": {
                  const t = this.evaluateCustomCssVariable(e.source);
                  return h.b(t, e);
                ...
                case "makeHsv": {
                  const t = this.evaluateCustomCssVariable(e.h),
                    n = this.evaluateCustomCssVariable(e.s),
                    o = this.evaluateCustomCssVariable(e.v);
                  return h.c(t, n, o);
                }
                case "map":
                ...
                case "ternary": {
                  const t = this.evaluateCustomCssVariable(e.source);
                  return this.evaluateCustomCssVariable(t ? e.true : e.false);
                }
                case "textColor": {
                  const t = this.evaluateCustomCssVariable(e.source),
            ...
            settingsChanged() {
              this.updateAllStyles(),
                this.publicAPI.addon.settings.dispatchEvent(
                  new CustomEvent("change")
                );
            }
            dynamicEnable() {
              this.loading ||
                ((this.publicAPI.addon.self.disabled = !1),
                this.updateAllStyles(),
                this.publicAPI.addon.self.dispatchEvent(
                  new CustomEvent("reenabled")
                ));
            }
            dynamicDisable() {
              this.loading ||
            ...
            async run() {
              this.manifest.editorOnly &&
                (await (() => {
                  if (
                    f.a.state.scratchGui.mode.isPlayerOnly &&
                    !f.a.state.scratchGui.mode.isEmbedded
                  )
                    return new Promise((e) => {
                      const t = () => {
                        f.a.state.scratchGui.mode.isPlayerOnly ||
                          (e(), f.a.removeEventListener("statechanged", t));
                      };
                      f.a.initialize(), f.a.addEventListener("statechanged", t);
                    });
                })());
              const e = await u.a[this.id]();
              (this.resources = e.resources),
                this.manifest.noTranslations || (await _);
              const t = 100 * Object(m.a)(this.id);
              if (this.manifest.userstyles)
                for (let e = 0; e < this.manifest.userstyles.length; e++) {
                  const n = this.manifest.userstyles[e],
                    o = t + e,
                    r = () =>
                      !this.publicAPI.addon.self.disabled &&
                      s.a.evaluateCondition(this.id, n.if);
                  for (const [e, t] of this.resources[n.url]) {
                    b.a(e, t).addDependent(this.id, o, r);
                  }
                }
              const n = ".".concat(x(this.id), "{display:none !important;}");
              if (
                (b
                  .a("_disabled/".concat(this.id), n)
                  .addDependent(
                    this.id,
                    t,
                    () => this.publicAPI.addon.self.disabled
                ...
                this.manifest.userscripts)
              )
                for (const e of this.manifest.userscripts) {
                  if (!s.a.evaluateCondition(e.if)) continue;
                  (0, this.resources[e.url])(this.publicAPI);
                }
              this.loading = !1;
            }
          }
          ...
          s.a.addEventListener("addon-changed", (e) => {
            const t = e.detail.addonId,
              n = P.instances.find((e) => e.id === t);
            n && n.settingsChanged(),
              e.detail.dynamicEnable
                ? n
                  ? n.dynamicEnable()
                  : B(t)
                : e.detail.dynamicDisable && n && n.dynamicDisable();
          });
          for (const e of Object.keys(c.a)) s.a.getAddonEnabled(e) && B(e);
        }.call(this, n(152));
    },
  },
]);
//# sourceMappingURL=addons.ec39b25e972e59e64b18.js.map
