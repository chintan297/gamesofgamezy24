function createUnityInstance(e, t, r)
{
    ...
    }(), f.cachedFetch = function()
    {
        ...
        {
            e = e ||
            {}, this.headers = new Headers, Object.keys(e.headers).forEach(function(t)
            {
            ...
            require: function(e)
            {
                var t = {
                    ...
                    "zlib/inflate.js": function(e, t, r)
                    {
                        ...
                        {
                            var t;
                            return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = z, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new w.Buf32(me), t.distcode = t.distdyn = new w.Buf32(ge), t.sane = 1, t.back = -1, T) : L
                        }
                        ...
                        {
                            var r, n;
                            return e && e.state ? (n = e.state, t < 0 ? (r = 0, t = -t) : (r = (t >> 4) + 1, t < 48 && (t &= 15)), t && (t < 8 || t > 15) ? L : (null !== n.window && n.wbits !== t && (n.window = null), n.wrap = r, n.wbits = t, i(e))) : L
                        }

                        function l(e, t)
                        {
                            var r, n;
                            return e ? (n = new o, e.state = n, n.window = null, r = s(e, t), r !== T && (e.state = null), r) : L
                        }
                        ...
                        function f(e, t)
                        {
                            ...
                            r = e.state, r.mode === V && (r.mode = Y), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = r.hold, h = r.bits, b = l, m = d, _e = T;
                            e: for (;;) switch (r.mode)
                            {
                                case z:
                                    if (0 === r.wrap)
                                    ...
                                    r.dmax = 1 << xe, e.adler = r.check = 1, r.mode = 512 & f ? G : V, f = 0, h = 0;
                                    break;
                                case N:
                                    for (; h < 16;)
                                    {
                                ...
                                case K:
                                    if (0 === r.havedict) return e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, r.hold = f, r.bits = h, O;
                                ...
                                case ne:
                                    if (l >= 6 && d >= 258)
                                    {
                                        e.next_out = s, e.avail_out = d, e.next_in = i, e.avail_in = l, r.hold = f, r.bits = h, k(e, m), s = e.next_out, a = e.output, d = e.avail_out, i = e.next_in, o = e.input, l = e.avail_in, f = r.hold, h = r.bits, r.mode === V && (r.back = -1);
                                        break
                                    }
                        ...
                        {
                            var r;
                            return e && e.state ? (r = e.state, 0 === (2 & r.wrap) ? L : (r.head = t, t.done = !1, T)) : L
                        }

                        function m(e, t)
                        {
                            var r, n, o, a = t.length;
                            return e && e.state ? (r = e.state, 0 !== r.wrap && r.mode !== K ? L : r.mode === K && (n = 1, n = v(n, t, a, 0), n !== r.check) ? A : (o = c(e, t, a, a)) ? (r.mode = he, I) : (r.havedict = 1, T)) : L
                        }
                    ...
                    "zlib/inftrees.js": function(e, t, r)
                    {
                        ...
                        t.exports = function(e, t, r, b, m, g, p, w)
                        {
                            ...
                            for (A = U, L = o; L >= 1 && 0 === j[L]; L--);
                            if (A > L && (A = L), 0 === L) return m[g++] = 20971520, m[g++] = 20971520, w.bits = 1, 0;
                            for (O = 1; O < L && 0 === j[O]; O++);
                            for (A < O && (A = O), P = 1, T = 1; T <= o; T++)
                                if (P <<= 1, P -= j[T], P < 0) return -1;
                            if (P > 0 && (e === s || 1 !== L)) return -1;
                            for (H[1] = 0, T = 1; T < o; T++) H[T + 1] = H[T] + j[T];
                            for (R = 0; R < b; R++) 0 !== t[r + R] && (p[H[t[r + R]]++] = R);
                            if (e === s ? (F = M = p, S = 19) : e === l ? (F = u, Z -= 257, M = c, W -= 257, S = 256) : (F = f, M = h, S = -1), N = 0, R = 0, T = O, _ = g, I = A, D = 0, k = -1, z = 1 << A, x = z - 1, e === l && z > a || e === d && z > i) return 1;
                            for (;;)
                            {
                                E = T - D, p[R] < S ? (C = 0, B = p[R]) : p[R] > S ? (C = M[W + p[R]], B = F[Z + p[R]]) : (C = 96, B = 0), v = 1 << T - D, y = 1 << I, O = y;
                                do y -= v, m[_ + (N >> D) + y] = E << 24 | C << 16 | B | 0; while (0 !== y);
                                for (v = 1 << T - 1; N & v;) v >>= 1;
                                ...
                                if (T > A && (N & x) !== k)
                                {
                                    for (0 === D && (D = A), _ += O, I = T - D, P = 1 << I; I + D < L && (P -= j[I + D], !(P <= 0));) I++, P <<= 1;
                                    if (z += 1 << I, e === l && z > a || e === d && z > i) return 1;
                                    k = N & x, m[k] = A << 24 | I << 16 | _ - g | 0
                                }
                            }
                            return 0 !== N && (m[_ + N] = T - D << 24 | 64 << 16 | 0), w.bits = A, 0
                        }
                    }
                };
    ...
    return new Promise(function(e, t)
    {
        f.SystemInfo.hasWebGL ? f.SystemInfo.hasWasm ? (f.startupErrorHandler = t, r(0), f.postRun.push(function()
        {
