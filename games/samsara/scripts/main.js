// @last_modified_by: 49.J , @Last Modified time: 2024-03-06 15:00:58
"use strict";
{
    ...
    _OnKeyEvent(name, e) {
      ...
      if (this._iRuntime.IsAnyWebView2Wrapper()) {
        ...
        if (
          ...
          (e.ctrlKey && blockKeysWithCtrl.includes(e.key))
        )
          e.preventDefault();
      }
      if (this._isExportToVideo) return;
...
("use strict");
{
  ...
  const HANDLER_CLASS = class ButtonDOMHandler extends self.DOMElementHandler {
    ...
    CreateElement(elementId, e) {
      ...
      mainElem.addEventListener("contextmenu", (e) => e.preventDefault());
